...
output "compliance_ci_toolchain_id" {
  ...
  value       = try(module.devsecops_ci_toolchain[0].toolchain_id, "Not created")
}

output "compliance_cd_toolchain_id" {
  description = "The ID of the Compliance CD Toolchain"
  value       = try(module.devsecops_cd_toolchain[0].toolchain_id, "Not created")
}

output "compliance_cc_toolchain_id" {
  description = "The ID of the Compliance CC Toolchain"
  value       = try(module.devsecops_cc_toolchain[0].toolchain_id, "Not created")
}
