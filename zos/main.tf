...
locals {
  ...
  app_source_repo_url = (
    ...
    format("%s/open-toolchain/zopeneditor-sample.git", local.compliance_pipelines_git_server)
  )
...
module "devsecops_ci_toolchain" {
  ...
  app_repo_clone_from_branch     = (var.ci_app_repo_clone_from_branch == "") ? "master" : var.ci_app_repo_clone_from_branch
  ...
  zos_secret_key_name   = (var.ci_zos_secret_key_name == "") ? var.zos_secret_key_name : var.ci_zos_secret_key_name
...
module "devsecops_cd_toolchain" {
  ...
  zos_secret_key_name   = (var.cd_zos_secret_key_name == "") ? var.zos_secret_key_name : var.cd_zos_secret_key_name
...
module "devsecops_cc_toolchain" {
  ...
  zos_secret_key_name = (var.cc_zos_secret_key_name == "") ? var.zos_secret_key_name : var.cc_zos_secret_key_name
