...
| <a name="input_cc_slack_channel_name"></a> [cc\_slack\_channel\_name](#input\_cc\_slack\_channel\_name) | The Slack channel that notifications is posted to. | `string` | `"my-channel"` | no |
...
| <a name="input_cc_sm_secret_group"></a> [cc\_sm\_secret\_group](#input\_cc\_sm\_secret\_group) | The Secrets Manager secret group containing your secrets. | `string` | `""` | no |
...
| <a name="input_cd_sm_secret_group"></a> [cd\_sm\_secret\_group](#input\_cd\_sm\_secret\_group) | The Secrets Manager secret group containing your secrets. | `string` | `""` | no |
...
| <a name="input_ci_sm_secret_group"></a> [ci\_sm\_secret\_group](#input\_ci\_sm\_secret\_group) | The Secrets Manager secret group containing your secrets. | `string` | `""` | no |
...
| <a name="input_toolchain_region"></a> [toolchain\_region](#input\_toolchain\_region) | IBM Cloud region where your toolchain is be created. | `string` | `"us-south"` | no |
...
| <a name="output_compliance_cc_toolchain_id"></a> [compliance\_cc\_toolchain\_id](#output\_compliance\_cc\_toolchain\_id) | The ID of the Compliance CI Toolchain |
| <a name="output_compliance_cd_toolchain_id"></a> [compliance\_cd\_toolchain\_id](#output\_compliance\_cd\_toolchain\_id) | The ID of the Compliance CI Toolchain |
