...
variable "ci_app_name" {
  ...
  default     = "zopeneditor-sample-compliance-app"
}
...
variable "deployment_target" {
  type        = string
  description = "The deployment target Kubernetes, Code-Engine or ZOs."
  default     = "zos"
}
...
variable "ci_zos_dbb_hlq" {
  type        = string
  description = "The ZOS DBB HLQ."
  default     = ""
}

variable "ci_zos_dbb_user" {
  type        = string
  description = "The ZOS DBB user."
  default     = ""
}
...
variable "cd_zos_dbb_hlq" {
  type        = string
  description = "The ZOS DBB HLQ."
  default     = ""
}

variable "cd_zos_dbb_user" {
  type        = string
  description = "The ZOS DBB user."
  default     = ""
}
...
variable "cc_zos_dbb_hlq" {
  type        = string
  description = "The ZOS DBB HLQ."
  default     = ""
}

variable "cc_zos_dbb_user" {
  type        = string
  description = "The ZOS DBB user."
  default     = ""
}
