...
| <a name="input_cc_zos_secret_key_name"></a> [cc\_zos\_secret\_key\_name](#input\_cc\_zos\_secret\_key\_name) | API key used to create the toolchains. | `string` | `""` | no |
...
| <a name="input_cd_zos_secret_key_name"></a> [cd\_zos\_secret\_key\_name](#input\_cd\_zos\_secret\_key\_name) | API key used to create the toolchains. | `string` | `""` | no |
...
| <a name="input_ci_zos_secret_key_name"></a> [ci\_zos\_secret\_key\_name](#input\_ci\_zos\_secret\_key\_name) | API key used to create the toolchains. | `string` | `""` | no |
...
| <a name="input_deployment_target"></a> [deployment\_target](#input\_deployment\_target) | The deployment target Kubernetes, Code-Engine or ZOs. | `string` | `"zos"` | no |
...
| <a name="input_zos_dbb_hlq"></a> [zos\_dbb\_hlq](#input\_zos\_dbb\_hlq) | The ZOS DBB HLQ. | `string` | `""` | no |
...
| <a name="input_zos_secret_key_name"></a> [zos\_secret\_key\_name](#input\_zos\_secret\_key\_name) | API key used to create the toolchains. | `string` | `""` | no |
